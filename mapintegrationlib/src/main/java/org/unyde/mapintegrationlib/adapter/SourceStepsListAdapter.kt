...
class SourceStepsListAdapter(internal var instruction_list: MutableList<String>?
                      ,internal var  instruction_site_list :MutableList<String>?
                      ,internal var  instruction_direction_list :MutableList<Int>?
                      ,internal var context: Context
) : RecyclerView.Adapter<SourceStepsListAdapterViewholder>() {
    ...
    override fun onBindViewHolder(holder: SourceStepsListAdapterViewholder, position: Int) {
...
class SourceStepsListAdapterViewholder(itemView: View) : RecyclerView.ViewHolder(itemView) {
